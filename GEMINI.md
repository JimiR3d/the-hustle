...
- **Taller Ground Horizon Anchoring:** Ground layer is anchored from its top horizon position (`top: 67vh;`), preserving the visible horizon while allowing all extra image height to extend downward as overscan for the upward parallax scrub (`yPercent: -38`).
