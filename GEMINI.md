...
- Moving border light line track from `Moving border.txt` (`.moving-border-line`) aligned pixel-perfectly (`x="14" y="14" width="402" height="312" rx="36"`) gliding around the outer container perimeter at `z-index: 2` (passing cleanly *under* the "TEAM N" header pills and *under* the bottom score board pills).
...
- Clean, dark, wide curved capsule Score Board pill (`score_board.png`) with pixelated LED score numbers (`VT323`).
